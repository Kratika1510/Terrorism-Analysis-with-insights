"""
Created on Tue Sep 08 19:34:48 2020

@author: Kratika Kothari
"""
...
def load_data():
  ...
  chart_dropdown_values = {"Terrorist Organisation":'gname', "Target Nationality":'natlty1_txt', "Target Type":'targtype1_txt', 
...
def create_app8_ui():
  ...
  html.H1(children='TERRORISM  ANALYSIS  WITH  INSIGHTS',style={'textAlign':'center','background-color':'black','color':'white'}, id='Main_title'),
  html.Br(),
  
  dcc.Tabs(id="Tabs", value="Map",children=[
      dcc.Tab(label="Map tool" ,id="Map tool",value="Map",style={'background-color':'black','color':'white','font-size':'20px'}, children=[
          dcc.Tabs(id = "subtabs", value = "WorldMap",style={'background-color':'black','color':'white','font-size':'20px'},children = [
              dcc.Tab(label="World Map tool", id="World", value="WorldMap",style={'background-color':'black','color':'white','font-size':'20px'}),
              dcc.Tab(label="India Map tool", id="India", value="IndiaMap",style={'background-color':'black','color':'white','font-size':'20px'})
              ]),
      ...
      dcc.Tab(label = "Chart Tool", id="chart tool", value="Chart", style={'background-color':'black','color':'white','font-size':'20px'},children=[
          dcc.Tabs(id = "subtabs2", value = "WorldChart",style={'background-color':'black','color':'white','font-size':'20px'},children = [
              dcc.Tab(label="World Chart tool", id="WorldC", value="WorldChart",style={'background-color':'black','color':'white','font-size':'20px'}),          
            dcc.Tab(label="India Chart tool", id="IndiaC", value="IndiaChart",style={'background-color':'black','color':'white','font-size':'20px'})]),
